...
private:
    ...
    inline double j_lambda(double lambda, double Te, double ne, double ni, int Z, double gff);
    inline double alpha_lambda(double lambda, double Te, double ne, double ni, int Z, double gff);
    ...
    inline double log10_gamma2(int Z, double Te);
