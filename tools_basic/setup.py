...
setup(
    ...
    description='Python toolkit to make work with POLARIS easier',  # Optional
    ...
    keywords='radiative_transfer plotting data_analysis',  # Optional
