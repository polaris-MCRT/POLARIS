...
<task> 1
    ...
    <source_extended_star nr_photons = "1e8">    0 -14959787070 0 1.0 6000 1

    # Monte Carlo dust scattering in planetary atmosphere
    <cmd>    CMD_PLANET_SCATTERING

    # path of the input grid file
    <path_grid>    "projects/rayleigh/rayleigh_0.1.dat"
    # path for all output data
    <path_out>    "projects/ocean/"

    # surface reflection
    # "type" parameter
    <surface_reflection>    "ocean" 0.2 10 1.33
